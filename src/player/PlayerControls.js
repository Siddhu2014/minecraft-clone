...
export class PlayerControls extends PointerLockControls {
    ...
    update() {
        ...
        camera.ySpeed += CameraConstants.GRAVITY_VELOCITY;
        this.getObject().position.y += camera.ySpeed;
    ...
    placeVoxel(voxel) {
        ...
        if (intersection) {
            ...
            if (canPlace) {
                ...
                if (voxel === WorldConstants.BLOCK_TYPES.AIR) {
                    this.soundManager.breakBlock();
                } else {
                    this.soundManager.placeBlock();
                }
            }
        }
    }
